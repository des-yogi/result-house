...
!function (t) {
  ...
  e.m = t, e.c = s, e.d = function (t, s, n) {
    ...
    if (e.r(n), Object.defineProperty(n, "default", {
      enumerable: !0,
      value: t
    }), 2 & s && "string" != typeof t) for (var i in t) e.d(n, i, function (s) {
      return t[s];
    }.bind(null, i));
    return n;
  }, e.n = function (t) {
  ...
  class o {
    constructor(t, s = o.options) {
      this.header = "string" == typeof t ? document.querySelector(t) : t, t && (this.opts = Object.assign(s, o.options), this.initHooks(), this.initScroll());
    }
    ...
    initScroll() {
      ...
      const e = (t = {}) => {
        var e = document.documentElement.scrollTop || document.body.scrollTop,
            n = s - e,
            i = n < 0 ? "down" : "up";
        n = Math.abs(n), s = e, this.state == o.UNPINNED ? "up" == i && (e < this.opts.scroll.pin || n > this.opts.scroll.tolerance) && this.pin() : this.state == o.PINNED ? "down" == i && e > this.opts.scroll.unpin && n > this.opts.scroll.tolerance && this.unpin() : this.pin();
      };
    ...
    pin() {
      this.header.classList.add("mh-pinned"), this.header.classList.remove("mh-unpinned"), this.state = o.PINNED, this.trigger("pinned");
    }

    unpin() {
      this.header.classList.remove("mh-pinned"), this.header.classList.add("mh-unpinned"), this.state = o.UNPINNED, this.trigger("unpinned");
    }
    ...
    bind(t, s) {
      this.hooks[t] = this.hooks[t] || [], this.hooks[t].push(s);
    }

    trigger(t, s) {
      if (this.hooks[t]) for (var e = 0, n = this.hooks[t].length; e < n; e++) this.hooks[t][e].apply(this, s);
    }

  }

  o.version = "2.0.0", o.options = i, o.PINNED = "pinned", o.UNPINNED = "unpinned",
  /*!
   * mhead.js
   ...
   */
  window.Mhead = o, (n = window.jQuery || window.Zepto || null) && (n.fn.mhead = function (t) {
